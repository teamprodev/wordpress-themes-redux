        ...
        private function is_minimum_version () {
            ...
            if ($this->min_redux_version != '') {
                ...
                if (version_compare($redux_ver, $this->min_redux_version) < 0) {
                    ...
                    $msg = '<strong>' . esc_html__( 'The', 'digilab') . ' ' .  $this->ext_name . ' ' .  esc_html__('extension requires', 'digilab') . ' Redux Framework ' . esc_html__('version', 'digilab') . ' ' . $this->min_redux_version . ' ' .  esc_html__('or higher.','digilab' ) . '</strong>&nbsp;&nbsp;' . esc_html__( 'You are currently running', 'digilab') . ' Redux Framework ' . esc_html__('version','digilab' ) . ' ' . $redux_ver . '.<br/><br/>' . esc_html__('This field will not render in your option panel, and features of this extension will not be available until the latest version of','digilab' ) . ' Redux Framework ' . esc_html__('has been installed.','digilab' );
                    ...
                    if (method_exists('Redux_Admin_Notices', 'set_notice')) {
                        ...
                        echo digilab_sanitize_data($msg);
